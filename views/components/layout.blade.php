    ...
    <div class="fixed-sidebar shadow-md flex flex-col justify-between">
        <div>
            ...
            <div class="profile-container">
                <div class="profile-info">
                    ...
                    <a href="/profile" class="text-blue-500 hover:underline">View Profile</a>
                </div>
            </div>
        ...
        <div class="p-4">
            <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit"
                    class="block w-full text-center py-2 bg-red-500 text-white hover:bg-red-600 rounded">Logout</button>
            </form>
        </div>
    </div>
